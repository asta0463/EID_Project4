...
def process_function(msg):
  ...
  print("%f" % t2_amqp)
  print("%f" % t2_amqp)
  t3_amqp=t2_amqp-t1_amqp
  print(" Time difference for AMQP is %f" % t3_amqp)
  return;
...
class MyMainWindow(QtGui.QMainWindow):
    ...
    def WebTest(self):
        ...
        ws = websocket.create_connection("ws://10.201.20.32:8080/websocket")
        global t1_web
        t1_web=time.time()
    ...
    def AMQPTest(self):
        ...
        #Setup the Client to receive the message back from the server
